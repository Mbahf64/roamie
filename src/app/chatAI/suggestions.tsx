  ...
  return (
    <div className="w-[90vw] lg:w-[45vw] mt-6 flex flex-col items-start justify-center lg:items-center lg:px-0">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3 lg:grid-cols-3">
        <div className="lg:w-[190px] lg:pl-4 lg:pr-[21px] lg:pt-[15px] lg:pb-[15.40px] h-[50px] pl-[16px] pr-[50px] pt-[19px] pb-[17px] bg-[#f6faff]/30 hover:bg-[#f6faff] rounded-2xl border border-[#e5eaf0] justify-start items-center inline-flex cursor-pointer">
