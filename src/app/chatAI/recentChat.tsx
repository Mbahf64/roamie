...
/>
        ...
        <div className="gap-3 flex items-center lg:-mr-[0rem] 2xl:-m-[0rem]">
      ...
      {isGridVisible && (
        <ScrollArea className="w-[90vw] lg:w-[43vw] 2xl:w-[31vw] h-[20vh] lg:h-[200px] 2xl:h-[300px]">
          <div className="w-[90vw] lg:w-[43vw] 2xl:w-[31vw] mt-">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {suggestionsData.map((item) => (
                <div
                  key={item.id}
                  className="w-[90vw] h-[82px] lg:w-[184.8px] 2xl:w-[190px] lg:h-[130px] p-4 bg-[#f6faff] rounded-2xl border border-[#e5eaf0] justify-start items-center inline-flex"
                >
